...
function Sidebar({page,go,sideOpen,alerts,data,viewportWidth,isAdmin,onManageProjects,darkMode,onToggleDark,onLogout,financeAuthed,analysisAuthed,costAuthed,procurementAuthed}) {
  ...
  const NAV = [
    ...
    {id:"procurement", icon:"📋", label:"Procurement", desc:"PR → PO → GRN → SES tracking", locked:!procurementAuthed},
